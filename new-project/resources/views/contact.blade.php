<x-layout>
    ...
    <section class="text-center py-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 animate-fadeIn">
            <div class="p-4 shadow-lg text-gray-200 rounded-lg bg-black hover:bg-gray-200 hover:text-black transition-colors">
    ...
    <section class="bg-gray-100 py-12 px-4">
        ...
        <form class="max-w-2xl mx-auto mt-8 space-y-8">
            ...
            <button type="submit" class="w-full bg-black text-white py-3 rounded-lg shadow-lg hover:bg-gray-200 hover:text-black transition-colors">Send Message</button>
        </form>
    </section>
    <section class="text-center py-12 px-4">
